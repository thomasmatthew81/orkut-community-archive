...
package com.google.api.services.samples.orkut.cmdline;
...
import com.google.api.services.samples.orkut.cmdline.View;
...
public class OrkutSample {
     ...
     */
    private static final String APPLICATION_NAME = "OrkutSample";

    /** Directory to store user credentials. */
    private static final java.io.File DATA_STORE_DIR =
            new java.io.File(System.getProperty("user.home"), ".store/orkut_sample");
    ...
    private static Orkut orkut;

    /** Authorizes the installed application to access user's protected data. */
    private static Credential authorize() throws Exception {
        // load client secrets
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
                new InputStreamReader(OrkutSample.class.getResourceAsStream("/client_secrets.json")));
    ...
    private static void listCommunities() throws IOException {
        View.header1("Listing My Communities");
        Orkut.Communities.List communities = orkut.communities().list("me");
        CommunityList commList =  communities.execute();
